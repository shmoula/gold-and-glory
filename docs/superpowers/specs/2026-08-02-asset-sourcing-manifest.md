...
| --- | --- | --- | --- |
| Rubber chicken (timing cursor, 40×48) | **Hand-author final; CC0 bases available** | Chicken Round Cartoon `26012` (bloodsong); alt Cartoon Chicken `336590` (rockefeller) | Neither is a *rubber* chicken; legibility at 40×48 unverified. Hero asset — author it in house style |
