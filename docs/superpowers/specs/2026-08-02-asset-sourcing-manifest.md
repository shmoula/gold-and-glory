...
| Roman sandal                          | Hand-author (base available)               | feet in sandals `36859` (jonadab)                                                     | All candidates read modern, not caligae (replaced by hand-authored art in Phase 3; stock file removed) |
...
| Gold coin pile                        | **Pin**                                    | Pile of Golden Coins `43969` (J_Alves); alt Gold Coins Illustration `228358` (GDJ)    | Character composited separately (replaced by hand-authored art in Phase 3; stock file removed)         |
| Banana peel                           | **Pin**                                    | Banana Peel `2774` (Gerald_G)                                                         | Purpose-built slip gag                                                                                 |
| Cactus (bonus)                        | **Pin**                                    | Cactus `169087` (Julianvb98)                                                          | Sole style-appropriate candidate (replaced by hand-authored art in Phase 3; stock file removed)        |
